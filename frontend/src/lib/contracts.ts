export const TEMPOLOCK_ADDRESS = "0xDD236A5bE330C408D106Ed26b983d5F1D5b6187E" as const;
export const TEMPOBURN_ADDRESS = "0x6e4E1034f0df05251E97C358EE64527097cab695" as const;

export const TEMPOLOCK_ABI = [
  {
    type: "function",
    name: "createTimeLock",
    inputs: [
